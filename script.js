document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            var type = input.type;
            var name = input.name || input.placeholder || 'This field';
            ...
            if (value !== '' && input.hasAttribute('minlength') && value.length < parseInt(input.getAttribute('minlength'))) {
    ...
    var animatedElements = document.querySelectorAll('.fade-in, .fade-in-up, .fade-in-left, .fade-in-right');
    ...
    if (animatedElements.length > 0) {
        ...
        style.textContent = '.fade-in.visible, .fade-in-up.visible, .fade-in-left.visible, .fade-in-right.visible { opacity: 1 !important; }';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '297a479d-2537-4a01-94c8-16d00fc88e8f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '297a479d-2537-4a01-94c8-16d00fc88e8f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '297a479d-2537-4a01-94c8-16d00fc88e8f';
